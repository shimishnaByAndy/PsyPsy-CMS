import { Offcanvas as BSOffcanvas, OffcanvasHeader, OffcanvasTitle, OffcanvasBody, Dropdown, DropdownToggle, DropdownMenu, DropdownItem, Button, CardHeader, Card, CardBody, CardTitle, Col } from 'react-bootstrap';
      ...
      <Card>
        ...
        <CardBody>
          <div className="button-list">
            <Link onClick={toggle} className="btn btn-primary" data-bs-toggle="offcanvas" to="#offcanvasExample" role="button" aria-controls="offcanvasExample">
              Link with href
            </Link>
            ...
            <button onClick={toggle} className="btn btn-secondary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample">

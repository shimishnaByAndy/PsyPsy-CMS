      ...
      <Card>
        ...
        <CardBody>
          ...
          <div className="hstack gap-2">
            <Link onClick={toggle} className="btn btn-primary mb-2" data-bs-toggle="collapse" to="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
              Link with href
            </Link>
            <Button onClick={toggle} className="btn btn-primary mb-2" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
      ...
      <Card>
        ...
        <CardBody>
          <div className="hstack gap-2 mb-3">
            <Link onClick={toggleFirst} className="btn btn-primary" data-bs-toggle="collapse" to="#multiCollapseExample1" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">
              Toggle first element
            </Link>
            <button onClick={toggleSecond} className="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#multiCollapseExample2" aria-expanded="false" aria-controls="multiCollapseExample2">
              Toggle second element
            </button>
            <button onClick={toggleBoth} className="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target=".multi-collapse" aria-expanded="false" aria-controls="multiCollapseExample1 multiCollapseExample2">
...
const HorizontalCollapse = () => {
  ...
  return <Col lg={6}>
      <Card>
        ...
        <CardBody>
          <button onClick={toggle} className="btn btn-primary mb-2" type="button" data-bs-toggle="collapse" data-bs-target="#collapseWidthExample" aria-expanded="false" aria-controls="collapseWidthExample">
          ...
          minHeight: 135
            ...
            <Collapse dimension="width" in={isTrue}>
              <div>
                <CardBody className="card card-body mb-0" style={{
                width: 300
              }}>

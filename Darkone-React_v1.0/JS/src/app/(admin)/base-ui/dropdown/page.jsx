...
import { Button, ButtonGroup, Card, CardBody, CardHeader, CardTitle, Col, Dropdown, DropdownDivider, DropdownHeader, DropdownItem, DropdownMenu, DropdownToggle, FormCheck, FormControl, FormLabel, Row } from 'react-bootstrap';
          ...
          <CardBody>
            <div className="d-flex flex-wrap gap-2">
              ...
              <Dropdown className="btn-group">
                ...
                <DropdownToggle type="button" className="btn btn-secondary dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-expanded="false" data-bs-reference="parent">

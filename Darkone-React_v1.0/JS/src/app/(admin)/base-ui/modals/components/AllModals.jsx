      ...
      <Card>
        ...
        <CardBody>
          <div className="d-flex flex-wrap gap-2">
            ...
            <button onClick={toggleScrollableModel} type="button" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalCenteredScrollable">
          ...
          <div className="d-flex flex-wrap gap-2">
            <div className="hstack gap-2">
              <button onClick={() => openModalWithClass('modal-top')} type="button" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#topModal">
                Top Modal
              </button>
              <button onClick={() => openModalWithClass('modal-bottom')} type="button" className="btn btn-success " data-bs-toggle="modal" data-bs-target="#bottomModal">
                Bottom Modal
              </button>
            </div>
...
const ModalSizes = () => {
  ...
  return <Col lg={6}>
      <Card>
        ...
        <CardBody>
          <div className="hstack gap-2">
            <button onClick={() => openModalWithSize('xl')} type="button" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalXl">
              Extra large modal
            </button>
            <button onClick={() => openModalWithSize('lg')} type="button" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalLg">
              Large modal
            </button>
            <button onClick={() => openModalWithSize('sm')} type="button" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalSm">
              Small modal
            </button>
          </div>

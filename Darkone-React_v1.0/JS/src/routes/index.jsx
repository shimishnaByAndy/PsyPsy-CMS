...
export const appRoutes = [...initialRoutes,
// ...authRoutes,
...baseUIRoutes, ...formsRoutes, ...generalRoutes, ...chartsMapsRoutes, ...layoutsRoutes, ...tableRoutes, ...iconRoutes];
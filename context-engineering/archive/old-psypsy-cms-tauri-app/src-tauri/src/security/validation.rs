...
pub struct PatientInfo {
    ...
    #[validate(custom = "validate_zip_code")]
    pub zip_code: Option<String>,
    
    #[validate(custom = "validate_medical_record_number")]
    pub medical_record_number: String,
    
    #[validate(custom = "validate_insurance_policy")]
...
pub struct DiagnosisInfo {
    #[validate(custom = "validate_icd_10_code")]
...
pub struct SanitizationService {
    ...
    html_sanitizer_rules: sanitize_html::rules::Rules,
}
...
impl SanitizationService {
    ...
    pub fn new() -> Result<Self, SecurityError> {
        ...
        let html_sanitizer_rules = DEFAULT.clone();
